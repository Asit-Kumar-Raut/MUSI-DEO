...
import { Play, Pause, SkipBack, SkipForward, Shuffle, Repeat, Volume2, Download, Share2, Maximize2 } from 'lucide-react';
    ...
    <>
      <div style={{ height: '80px', background: '#181818', borderTop: '1px solid #282828', padding: '0 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0, zIndex: 200 }}>
        ...
        <div className="player-track" 
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '30%', minWidth: '180px', cursor: currentSong ? 'pointer' : 'default' }}>
          {currentSong ? (
            <>
              ...
              <div style={{ display: 'flex', gap: '10px', marginLeft: '10px' }} onClick={e => e.stopPropagation()}>
